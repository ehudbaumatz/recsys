...
nlp = spacy.load('en')
text = u'Savannah, GA 40 second local forecast from The Weather Channel. Current conditions, 5 day outlook, with highs, lows, and chance of rain'
#,"the weather channel,weather forecast channel,savannah ga weather forecast video,savannah ga weather video,507,savannah ga 40 second forecast video"
# ,News,Weather Forecast,Weather News,' "Savannah, GA 60 Second Forecast",
